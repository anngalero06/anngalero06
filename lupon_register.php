...
if(isset($_POST['submit'])){ 
        ...
        if($password != $confirm_password){
           ...
           <div class="email-container">
               ...
               <p style="font-size: 14px;">Verification code expires after 24 hours. Log in using your registered email address and password.<p>
                ...
                <button class="btn btn-primary"><a href="http://localhost/barangay%20justice%20management%20system%2001/verification.php?email='.$email.'" style="text-decoration: none; color: #fff; font-weight: 600; text-transform: uppercase;">Verify my email</a></button>
                </div>
               <br>
  ...
  ';
      ...
      if($mail->send())
      {
        ...
        mysqli_query($conn, "INSERT INTO `lupon_accounts`(first_name, last_name, email, password, pb_id, verification_code) VALUES('$first_name', '$last_name', '$email', '$confirm_password', '$pb_id', '$verification_code')") or die('query failed');
        echo "
        <style>
        ...
        hr{
            ...
            <div class='popup' id='popup'>
                <h2>Success! Verification Email Sent</h2>
                <hr></hr>
                <p>We've just sent a verification email to the address you provided. Please check your inbox shortly. In the email, you'll find a verification code that you'll need to complete the account verification process.</p>
        ...
        <script>
            ...
            // Call the displayPopup function when the email is sent successfully
            displayPopup();
        </script>
    ";
      }
